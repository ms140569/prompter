...
pub fn _crazy_theme() -> Theme {

    let mut theme: Theme = [0; THEME_SIZE];

    theme[RESET] = -99;

    theme[ USERNAME_FG] = -99;
    theme[ USERNAME_BG] = -99;
    theme[ USERNAME_ROOT_BG] = -99;

    theme[ HOSTNAME_FG] = -99;
    theme[ HOSTNAME_BG] = -99;

    theme[ HOME_SPECIAL_DISPLAY] = 1;
    theme[ HOME_BG] = -99;  // blueish
    theme[ HOME_FG] = -99;  // white
    theme[ PATH_BG] = -99;  // dark grey
    theme[PATH_FG] = -99;  // light grey
    theme[CWD_FG] = -99;  // nearly-white grey
    theme[SEPARATOR_FG] = -99;
